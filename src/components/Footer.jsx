...
const Footer = ({ theme }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-slate-50 dark:bg-gray-900 pt-10 ms:pt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40"
    >
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <p className="text-sm mt-2 mb-6">
            The latest news, articles, and recources, sent to your inbox wekkly.
          </p>
      ...
      >
        <p className="text-sm text-gray-600 dark:text-gray-400 text-center pb-10">
